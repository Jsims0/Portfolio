...
```{r}
#| output: true
#runFolder <- 'XXXXXXXXXXXXXXXXXXXXX/Users/jsims/Faroe/20220519_P2-13_0084_A141KYOLO3'
#runFolder2 <- 'XXXXXXXXXXXXXXXXXXXXX/Users/jsims/Faroe/20220519_P2-13_0084_A141KYOLO3'
#tile <- '1_1133'
#tile.run2 <- '8_1133'
...
```{r}
chastPlotRelPosInterRun(list_run1[[4]], list_run2[[4]], list_run1[[2]], list_run2[[2]], run1_data[[4]], run2_data[[4]], bed_name)
...
```{r}
plotMutFrequencyInterRun(run1_data[[6]], run2_data[[6]], run1_data[[5]], run2_data[[5]], Grange_object_r1_run1, Grange_object_r1_run2, c('+-', '-+'), 0, run1_data[[4]], run2_data[[4]],  bed_name)
